sap.ui.define([
    ...
    var _aListItem = [];
    return BaseController.extend("auro.eng.inv.testingapp.controller.Detail", {
        ...
        _onObjectMatched: function (oEvent) {
            var _oArgs= oEvent().getParameter("arguments");
        ...
        _bindView: function (sObjectPath) {
            ...
            oQuery = oArgs["?query"];
			if (oQuery && _aListItem.indexOf(oQuery.item) > -1){
				oView.getModel("detailView").setProperty("/includeItemInSelection", oQuery.item);
			} else {
        ...
        onCloseDetailPress: function () {
            ...
            // this.getOwnerComponent().oListSelector.clearListListSelection();
            // this.getOwnerComponent().oListSelector._oList.removeSelections();
