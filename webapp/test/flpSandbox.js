		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders App",
									"targetURL": "#auroenginvtestingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"auroenginvtestingapp-display": {
								"semanticObject": "auroenginvtestingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=auro.eng.inv.testingapp",
									"url": sap.ui.require.toUrl("auro/eng/inv/testingapp")
								}
							}
						}
					}
